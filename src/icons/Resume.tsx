...
export const Resume = ({ filled = false }: IconProps) => (
  <svg
  ...
  >
    {filled ? (
      <>
        <path
          fill="#4285F4"
          d="M433.9 97.95L350 14.05c-9-9-21.2-14.1-33.9-14.1H112c-26.5.1-48 21.6-48 48.1v416c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48v-332.1c0-12.7-5.1-25-14.1-34z"
        />
        <path
          fill="#A1C2FA"
          d="M320 32.05v95.5h95.5c-0.7-2.8-2.1-5.3-4.2-7.4l-83.3-83.3c-2.1-2.1-4.6-3.5-7.4-4.2z"
        />
        <rect x="160" y="224" width="192" height="32" rx="12" fill="#F1F1F1" />
        <rect x="160" y="288" width="192" height="32" rx="12" fill="#F1F1F1" />
        <rect x="160" y="352" width="192" height="32" rx="12" fill="#F1F1F1" />
      </>
    ) : (
      <path
        fill="currentColor"
